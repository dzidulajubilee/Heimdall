/**
 * Heimdall IDS Dashboard — app.jsx
...
const THEMES = [
  ...
  { id: 'terminal',  label: 'Terminal',       accent: '#00ff41', dot: '#031507' },
];
...
function App() {
  ...
  useEffect(() => {
    ...
    if (activeView === 'charts') {
      ...
      fetch('/charts?trend=24&days=1').then(r=>r.json()).then(d=>{
        setChartData(d); setChartLoading(false);
